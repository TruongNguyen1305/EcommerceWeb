...
namespace EcommerceWebApp.Areas.Admin.Controllers
{
    ...
    public class AdminCustomersController : Controller
    {
        ...
        public AdminCustomersController(EcommerceShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(int? page)
        {
            ...
            var pageSize = 20;
            var customersList = _context.Customers.AsNoTracking().Include(x=>x.Location).OrderByDescending(x => x.CustomerId);
            PagedList<Customer> models = new PagedList<Customer>(customersList, pageNumber, pageSize);
