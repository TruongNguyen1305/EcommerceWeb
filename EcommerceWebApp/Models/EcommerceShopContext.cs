...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server= LAPTOP-J9OI3DHT\\TRUONGCRIS; Database=EcommerceShop;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Account>(entity =>
            {
                ...
                entity.Property(e => e.Salt).HasMaxLength(6);
            ...
            modelBuilder.Entity<Category>(entity =>
            {
                entity.HasKey(e => e.CatId)
                    .HasName("PK__Categori__6A1C8ADA49841E4F");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.HasOne(d => d.Location)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("fk_locationId_customer");
            });
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasOne(d => d.TransactStatus)
                    ...
                    .HasConstraintName("fk_TransactStatusID_Oder");
            });
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasOne(d => d.Cat)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("fk_catId_products");
            });
